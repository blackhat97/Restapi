...
CREATE TABLE IF NOT EXISTS `main`.`account` (
...
CREATE TABLE IF NOT EXISTS `main`.`comic` (
...
CREATE TABLE IF NOT EXISTS `main`.`volume` (
...
CREATE TABLE IF NOT EXISTS `main`.`chapter` (
...
CREATE TABLE IF NOT EXISTS `main`.`page` (
