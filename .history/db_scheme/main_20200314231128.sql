...
CREATE TYPE main.USER_ROLE AS ENUM ('user', 'mod', 'admin');
...
CREATE TABLE main.Account (
    ...
    role                main.USER_ROLE DEFAULT 'user' NOT NULL
);
...
CREATE TYPE main.ORGANIZATION_TYPE AS ENUM ('pages', 'chapters', 'volumes');
...
CREATE TABLE main.Comic (
    ...
    organization        main.ORGANIZATION_TYPE DEFAULT 'chapters' NOT NULL,
...
CREATE TYPE main.RELEASE_FREQUENCY  AS ENUM ('weekly', 'monthly');

CREATE TABLE main.Schedule (
    comicID             INTEGER,
    updateDay           INTEGER, -- Range is 1 to 7, where Sunday is 1 and Saturday is 7
    updateType          main.RELEASE_FREQUENCY NOT NULL,
